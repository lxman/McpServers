...
public class Program
{
    public static async Task Main(string[] args)
    {
        ...
        // MongoDB.Driver and other components can write warnings to stdout
        ...
        builder.Services
            ...
            .AddLogging(logging =>
            {
                ...
                logging.AddFilter("MongoDB", LogLevel.None);
            })
            // Add MCP Server with stdio transport
            .AddMcpServer()
            .WithStdioServerTransport()
            // Register all MongoDB tools
