...
namespace DesktopCommander.Services.AdvancedFileEditing;
...
public class LineBasedEditor(DiffPatchService diffPatchService, IndentationManager indentationManager)
{
    ...
    /// </summary>
    public (bool success, string[] newLines, string? errorMessage) ReplaceLines(
    ...
    /// </summary>
    public (bool success, string[] newLines, string? errorMessage) InsertAfterLine(
        string[] originalLines, 
        int afterLine, 
        string content)
    {
    ...
    /// </summary>
    public (bool success, string[] newLines, string? errorMessage) DeleteLines(
        string[] originalLines, 
        int startLine, 
        int endLine)
    {
