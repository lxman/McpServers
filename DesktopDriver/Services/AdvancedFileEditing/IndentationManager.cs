...
public class IndentationManager
{
    ...
    public static IndentationInfo DetectFileIndentation(string[] lines)
    {
        ...
        if (indentationSamples.Count == 0)
            return new IndentationInfo(IndentationType.Spaces, 4, 0); // Default
        ...
        if (dominantType == IndentationType.Spaces)
        {
            ...
            return new IndentationInfo(IndentationType.Spaces, dominantSize, 0);
        }
        
        return new IndentationInfo(dominantType, dominantType == IndentationType.Tabs ? 1 : 4, 0);
    }
