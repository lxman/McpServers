...
public class MarketIntelligenceService
{
    ...
    {
        _logger.LogInformation($"Generating market intelligence report for {recentJobs.Count} jobs");
        ...
        _logger.LogInformation($"Market intelligence report generated with {report.Recommendations.Count} recommendations");
