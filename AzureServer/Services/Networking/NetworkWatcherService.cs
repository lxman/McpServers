...
using NextHopResult = AzureServer.Services.Networking.Models.NextHopResult;
using SecurityGroupViewResult = AzureServer.Services.Networking.Models.SecurityGroupViewResult;
