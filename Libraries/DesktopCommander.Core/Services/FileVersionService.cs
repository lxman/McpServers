...
using System.Text;
using DesktopCommander.Core.Exceptions;
...
namespace DesktopCommander.Core.Services
{
    ...
    public class FileVersionService
    {
        ...
        public static string ComputeVersionToken(string filePath)
        {
        ...
        public static bool ValidateVersionToken(string filePath, string expectedToken)
        {
        ...
        public static void ValidateVersionTokenOrThrow(string filePath, string expectedToken)
        {
            if (string.IsNullOrWhiteSpace(expectedToken))
            {
