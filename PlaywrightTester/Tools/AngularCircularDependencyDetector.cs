...
public class AngularCircularDependencyDetector(PlaywrightSessionManager sessionManager)
{
    ...
    [McpServerTool]
    [Description("Detect circular dependencies in Angular applications with comprehensive analysis and resolution suggestions")]
    public async Task<string> DetectCircularDependencies(
        [Description("Session ID")] string sessionId = "default",
        [Description("Include detailed resolution suggestions")] bool includeResolutionSuggestions = true,
        [Description("Analyze architecture impact")] bool analyzeArchitectureImpact = true,
        [Description("Include performance impact analysis")] bool includePerformanceAnalysis = true,
        [Description("Detection method: 'dfs', 'tarjan', 'comprehensive'")] string detectionMethod = "comprehensive")
    {
        try
        {
