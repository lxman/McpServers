...
public class AngularPerformanceTools(PlaywrightSessionManager sessionManager)
{
    ...
    [McpServerTool]
    [Description("Profile individual component rendering performance and identify bottlenecks")]
    public async Task<string> ProfileComponentRenderTimes(
        [Description("Duration in seconds to monitor rendering")] int durationSeconds = 30,
        [Description("Maximum number of components to monitor")] int maxComponents = 25,
        [Description("Include detailed timing analysis")] bool includeDetailedAnalysis = true,
        [Description("Session ID")] string sessionId = "default")
    {
        try
        {
