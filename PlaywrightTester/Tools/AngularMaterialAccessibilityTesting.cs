...
public class AngularMaterialAccessibilityTesting(PlaywrightSessionManager sessionManager)
{
    ...
    [McpServerTool]
    [Description("Validate Angular Material components for accessibility compliance with comprehensive WCAG testing")]
    public async Task<string> ValidateMaterialAccessibilityCompliance(
        ...
        [Description("Specific Material component selector to test (optional)")] string componentSelector = "",
        [Description("WCAG compliance level (A, AA, AAA)")] string wcagLevel = "AA",
        [Description("Include detailed violation descriptions")] bool includeDetails = true,
        [Description("Test color contrast ratios")] bool testColorContrast = true,
        [Description("Test keyboard navigation patterns")] bool testKeyboardNavigation = true,
        [Description("Test screen reader compatibility")] bool testScreenReader = true,
        [Description("Generate remediation recommendations")] bool generateRecommendations = true)
    {
        try
        {
                ...
                (() => {
                    const results = {
                        ...
                        colorContrastAnalysis: {
                            tested: " + testColorContrast.ToString().ToLower() + @",
                            violations: [],
                            passedElements: [],
                        ...
                        keyboardNavigationAnalysis: {
                            tested: " + testKeyboardNavigation.ToString().ToLower() + @",
                            focusableElements: [],
                            tabOrder: [],
                            keyboardTraps: [],
                        ...
                        screenReaderAnalysis: {
                            tested: " + testScreenReader.ToString().ToLower() + @",
                            ariaLabels: [],
                            missingLabels: [],
                            incorrectRoles: [],
                            semanticStructure: {},
                    ...
                    const generateRecommendations = () => {
                        if (!" + generateRecommendations.ToString().ToLower() + @") return;
    ...
    [McpServerTool]
    [Description("Extract Angular Material theme and design token information for accessibility analysis")]
