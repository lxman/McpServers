...
[McpServerTool]
    ...
    [McpServerTool]
    [Description("Monitor Zone.js activity and async operations without waiting. See skills/playwright-mcp/tools/angular/stability-detection.md.")]
    ...
    [McpServerTool]
    [Description("Check current Angular application stability status without waiting. See skills/playwright-mcp/tools/angular/stability-detection.md.")]
